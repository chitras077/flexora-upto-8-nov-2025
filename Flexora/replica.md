...
**Route Organization**
The application uses a flat routing structure with dedicated pages for each tool category:
...
**Processing Logic**
All file processing happens client-side using browser APIs:
...
1. User selects tool category from home or navigation
2. Tool page loads with tabbed interface for feature selection
3. User uploads file or enters data
4. Processing happens immediately in browser
5. Results displayed with download or copy options
